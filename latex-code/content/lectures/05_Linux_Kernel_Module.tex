...
\begin{definition}{Module Skeleton}
    \begin{itemize}
        ...
        \item info macros: \texttt{MODULE\_LICENSE/AUTHOR/DESCRIPTION/VERSION}
    \end{itemize}
\end{definition}
...
\begin{example2}{Exam: Complete the Platform Driver (Task 2)}
    Fill the gaps so a \texttt{'1'} is written to the first GPIO address (from the
    device tree). Key fills:
    \tcblower
\begin{lstlisting}[language=C, style=basesmol, aboveskip=2pt, belowskip=2pt]
